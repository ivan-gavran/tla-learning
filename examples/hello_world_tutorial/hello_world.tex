...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} hello\_world}\moduleRightDash\cl{}
\fl{}
\fl{ {\EXTENDS} Sequences%
\@y{\@s{0}%
 Import \ensuremath{Sequences} module from the standard library
}%
}
\fl{}
\fl{ {\VARIABLES}}
...
\fl{}
\fl{ Init \.{\defeq}}
\fl{ \.{\land}}\al{11}{1}{ alices\_outbox \.{=} \{ \}%
\@y{\@s{0}%
 Alice\mbox{'}s memory of what she sent is the empty set
}%
}
\fl{ \.{\land}}\al{12}{1}{ network \.{=} \{ \}%
\@y{\@s{0}%
 AND so is the network
}%
}
\fl{ \.{\land}}\al{13}{1}{ bobs\_mood \.{=}\@w{neutral}%
\@y{\@s{0}%
 AND Bob\mbox{'}s mood is neutral
}%
}
\fl{ \.{\land}}\al{14}{1}{ bobs\_inbox \.{=} {\langle} {\rangle}%
\@y{\@s{0}%
 AND Bob\mbox{'}b inbox is an empty Sequence (list)
}%
}
\fl{}
\fl{ AliceSend ( m ) \.{\defeq}}
\fl{ \.{\land}}\al{17}{1}{ m \.{\notin} alices\_outbox}
 \fl{ \.{\land}}\al{18}{1}{ alices\_outbox \.{'} \.{=} alices\_outbox \.{\cup}
 \{ m \}}
\fl{ \.{\land}}\al{19}{1}{ network \.{'} \.{=} network \.{\cup} \{ m \}}
 \fl{ \.{\land}}\al{20}{1}{ {\UNCHANGED} {\langle} bobs\_mood ,\, bobs\_inbox
 {\rangle}}
\fl{}
\fl{ NetworkLoss \.{\defeq}}
 \fl{ \.{\land}}\al{23}{1}{ \E\, e \.{\in} network \.{:} network \.{'} \.{=}
 network \.{\,\backslash\,} \{ e \}}
 \fl{ \.{\land}}\al{24}{1}{ {\UNCHANGED} {\langle} bobs\_mood ,\, bobs\_inbox
 ,\, alices\_outbox {\rangle}}
\fl{}
\fl{ NetworkDeliver \.{\defeq}}
\fl{ \.{\land}}\al{27}{1}{ \E\, e \.{\in} network \.{:}}
 \fl{ \.{\land}}\al{28}{1}{ bobs\_inbox \.{'} \.{=} bobs\_inbox \.{\circ}
 {\langle} e {\rangle}}
 \fl{ \.{\land}}\al{29}{1}{ network \.{'} \.{=} network \.{\,\backslash\,} \{
 e \}}
 \fl{ \.{\land}}\al{30}{1}{ {\UNCHANGED} {\langle} bobs\_mood ,\,
 alices\_outbox {\rangle}}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{}
\fl{ BobCheckInbox \.{\defeq}}
\fl{ \.{\land}}\al{38}{1}{ (}
\fl{ \.{\lor}}\al{39}{1}{ (}
 \fl{ \.{\land}}\al{40}{1}{ bobs\_mood \.{'}}\al{40}{3}{
 \.{=}}\al{40}{4}{\@w{happy}}
 \fl{ \.{\land}}\al{41}{1}{ bobs\_inbox}\al{41}{2}{ \.{=}}\al{41}{3}{
 {\langle}\@w{hello} ,\,\@w{world} {\rangle}}
\fl{ )}
\fl{ \.{\lor}}\al{43}{1}{ (}
\fl{ \.{\land}}\al{44}{1}{ bobs\_mood \.{'}}\al{44}{3}{ \.{=}\@w{neutral}}
 \fl{ \.{\land}}\al{45}{1}{ bobs\_inbox}\al{45}{2}{ \.{\neq}
 {\langle}\@w{hello} ,\,\@w{world} {\rangle}}
\fl{}
\fl{ )}
\fl{ )}
 \fl{ \.{\land}}\al{49}{1}{ {\UNCHANGED} {\langle} network ,\, bobs\_inbox ,\,
 alices\_outbox {\rangle}}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{ Next \.{\defeq}}
\fl{ \.{\lor}}\al{55}{1}{ AliceSend (\@w{hello} )}
\fl{ \.{\lor}}\al{56}{1}{ AliceSend (\@w{world} )}
\fl{ \.{\lor}}\al{57}{1}{ NetworkLoss}
\fl{ \.{\lor}}\al{58}{1}{ NetworkDeliver}
\fl{ \.{\lor}}\al{59}{1}{ BobCheckInbox}
\fl{}
 \fl{ NothingUnexpectedInNetwork \.{\defeq} \A\, e \.{\in} network \.{:} e
 \.{\in} alices\_outbox}
\fl{}
\fl{ NotBobIsHappy \.{\defeq}}
\fl{ \.{\LET} BobIsHappy \.{\defeq} bobs\_mood \.{=}\@w{happy}}
\fl{ \.{\IN} {\lnot} BobIsHappy}
\fl{}
\fl{}\bottombar\cl{}
\end{document}

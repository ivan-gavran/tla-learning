 ...
 *)
\*  IG: we will use this to state that a commit has more than 2/3 of validators' votes
 ...
 *)            
\*  Q: where is the value for pMaxFaultyRationExclusive initialized? 
\* More generally, I am somewhat confused by the structure of this folder.
\* Apparently, entry points are files such as MC10_3_faulty.tla.
